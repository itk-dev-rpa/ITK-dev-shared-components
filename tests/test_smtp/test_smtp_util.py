...
class TestTreeUtil(unittest.TestCase):
    ...
    def test_send_simple(self):
        ...
        smtp_util.send_email("itk-rpa@mkb.aarhus.dk", "idsc@test.dk", "Test simple", "Test body", smtp_server="localhost", smtp_port=self.smtp_port)

        message = self.get_message("Test simple")
        self.assertEqual(message["From"]["Address"], "idsc@test.dk")
        self.assertEqual(message["To"][0]["Address"], "itk-rpa@mkb.aarhus.dk")
    ...
    def test_send_html(self):
        ...
        smtp_util.send_email("itk-rpa@mkb.aarhus.dk", "idsc@test.dk", "Test html", html, html_body=True, smtp_server="localhost", smtp_port=self.smtp_port)
    ...
    def test_send_attachments(self):
        ...
        smtp_util.send_email("itk-rpa@mkb.aarhus.dk", "idsc@test.dk", "Test files", "This email has three attached txt files.", attachments=attachments, smtp_server="localhost", smtp_port=self.smtp_port)
    ...
    def test_send_multiple(self):
        ...
        smtp_util.send_email(["itk-rpa@mkb.aarhus.dk", "itk-rpa@mkb.aarhus.dk"], "idsc@test.dk", "Test multiple", "This email has multiple receivers.", smtp_server="localhost", smtp_port=self.smtp_port)
